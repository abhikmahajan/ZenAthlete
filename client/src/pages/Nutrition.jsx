...
const Nutrition = () => {
  ...
  return (
    <div className='h-full overflow-y-scroll p-6 bg-slate-900 text-white '>
      <div>
        <h1 className='text-4xl font-bold mb-4'>Nutrition and Macros</h1>
        <p className='text-slate-400 mb-8'>Fill the details and get a proper nutritional plan:</p>
      </div>
    <div className=' flex items-start flex-wrap gap-6'>
      ...
      <form onSubmit={submitted} className='w-1/3 p-4 bg-slate-700 rounded-lg border border-gray-200'>
        <div className='flex gap-4'>
          ...
          <h1 className='text-xl font-semibold'>Nutritional Plan</h1>
        </div>
      ...
      <div className='mt-4'>
        <label className='text-sm font-medium'>Breakfast:</label><br/>
        <textarea rows={4} onChange={(e) => setBreakfast(e.target.value)} value={breakfast} className='w-full mt-2 p-2 px-3 outline-none text-sm rounded-md bg-zinc-800 border border-gray-300' placeholder='E.g., vegetarian, vegan, gluten-free, etc.'></textarea>
      </div>

      <div className='mt-4'>
        <label className='text-sm font-medium'>Lunch:</label><br/>
        <textarea rows={4} onChange={(e) => setLunch(e.target.value)} value={lunch} className='w-full mt-2 p-2 px-3 outline-none text-sm rounded-md bg-zinc-800 border border-gray-300' placeholder='E.g., vegetarian, vegan, gluten-free, etc.'></textarea>
      </div>

      <div className='mt-4'>
        <label className='text-sm font-medium'>Dinner:</label><br/>
        <textarea rows={4} onChange={(e) => setDinner(e.target.value)} value={dinner} className='w-full mt-2 p-2 px-3 outline-none text-sm rounded-md bg-zinc-800 border border-gray-300' placeholder='E.g., vegetarian, vegan, gluten-free, etc.'></textarea>
      </div>
      ...
      <div className='max-w-3xl w-full p-4 bg-slate-700 text-white rounded-lg flex flex-col border border-gray-200 min-h-96 max-h-[600px]'>
        <div className='flex items-center gap-3'>
          ...
          <h1 className='text-xl font-semibold'>Generated diet</h1>
        </div>
        ...
        {!content ? ( <div className='flex-1 flex justify-center items-center'>
          <div className='text-sm flex flex-col items-center gap-5'>
            ...
            <p>Enter details and click "Generate diet" to get started</p>
          </div>
          </div>) : (
